...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*᥀︙ عذرا لا تستطيع استخدام الامر على مبرمج السورس *","md",true)
end
...
if text and Redis:get(Saidi.."youtube"..msg.sender.user_id..msg_chat_id) then
  local m = json:decode(https.request("http://api.telegram.org/bot"..Token.."/sendAnimation?chat_id="..msg.chat_id.."&animation=https://t.me/trend_a1/222&reply_to_message_id="..msg.id/2097152/0.5)).result.message_id
  local typee = Redis:get(Saidi.."youtube"..msg.sender.user_id..msg_chat_id)
  local txx = io.popen('curl -s "https://xnxx.Fastbots.ml/apies/ytt.php?text='..URL.escape(text)..'&type='..typee..'"'):read('*a')
    if txx == "sizelimted" then
    LuaTele.sendText(msg.chat_id, msg.id,"• حجم الملف اكبر من 50 ميجا")
  else
    if typee == "mp3" then
      local msgg = msg_id/2097152/0.5
      https.request("https://api.telegram.org/bot"..Token.."/sendAudio?chat_id=" .. msg_chat_id .. "&Audio="..txx.."&caption=".. URL.escape("Done Downloaded").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true")
    elseif typee == "mp4" then
      local msgg = msg_id/2097152/0.5
      https.request("https://api.telegram.org/bot"..Token.."/sendVideo?chat_id=" .. msg_chat_id .. "&Video="..txx.."&caption=".. URL.escape("Done Downloaded").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true")
    end
    https.request("https://api.telegram.org/bot"..Token.."/deletemessage?chat_id="..msg.chat_id.."&message_id="..m)
  end
...
local RinkBot = msg.Name_Controller
photo = "https://t.me/glalkmeso/26193"
local Name = '* •═『•ꞏ𝐅𝐎𝐅𝐀𝐒𝐎𝐔𝐑𝐂𝐄 ｢♥️｣』═•\n*᥀︙ [⋆⃟➼𝐀𝐇𝐌𝐄𝐃 𝐊𝐇𝐀𝑳𝐄𝐃 ꕸ](t.me/bbbc6)*\n*᥀︙ [ꞏＣＨＡＮＮＥＬ ｢♥｣](t.me/glalkmeso)*\n•═『•ꞏ𝐅𝐎𝐅𝐀𝐒𝐎𝐔𝐑𝐂𝐄 ｢♥️｣』═•*'
keyboard = {}
keyboard.inline_keyboard = {
{
{text = '⸢𝐏𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑⸥', url = "http://t.me/bbbc6"},
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'مطور السورس' or text == 'احمد خالد' or text == 'مبرمج السورس' then
photo = "https://t.me/bbbc6"
local Name = '𓆩𝘾𝙊𝙉𝙉𝙀𝘾𝙏 𝙁𝙍𝙊𝙈 𝘽𝙊𝙏𝙏𝙊𝙉𓆪'
keyboard = {}
keyboard.inline_keyboard = {
{
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'بلالتتت' or text == 'احمد ااااالمصري' or text == 'مبرمج السورس' then
...
data = {
{
{text = '⸢𝚂𝙾𝚄𝚁𝙲𝙴 𝙵𝙰𝚂𝚃⸥', url = 't.me/otlop12'}, 
},
}
}
local TextHelp = [[*
