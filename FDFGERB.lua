...
Redis:del(FDFGERB.."nool:flotysb"..msg.reply_to_message_id)
...
K = 'محظوظ 2x'
F = '15000'
Redis:incrby(FDFGERB.."nool:xz"..msg.sender.user_id , F)
local ballancee = Redis:get(FDFGERB.."nool:xz"..msg.sender.user_id) or 0
local teex =
Redis:setex(FDFGERB.."innoo" .. msg.sender.user_id,600, true)
